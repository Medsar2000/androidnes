...
import com.androidemu.nes.input.Trackball;

import java.io.File;

public class Nesoid extends Activity implements GameKeyListener,
	...
	private boolean initEmulator() {
		...
		if (!emulator.initialize(libdir, "nes"))
			return false;
	...
	private void loadGlobalSettings() {
		...
		emulator.setOption("enableLightGun",
				settings.getBoolean("enableLightGun", false));
		emulator.setOption("soundEnabled", 
				settings.getBoolean("soundEnabled", true));
		emulator.setOption("accurateRendering",
				settings.getBoolean("accurateRendering", false));
